...
export const CardAccountButton = () => {
  ...
  return <div className="w-full flex flex-col gap-2 items-end">
    ...
    variant="outline" className="w-full hover:bg-zinc-800 bg-transparent dark:border-zinc-800">Settings</Button>
    <Button
    onClick={() => router.push("/admin")}
    variant="outline" className="w-full hover:bg-zinc-800 bg-transparent dark:border-zinc-800">Admin</Button>
